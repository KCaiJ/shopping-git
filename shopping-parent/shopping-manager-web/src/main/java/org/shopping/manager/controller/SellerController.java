...
public class SellerController {
	...
	public Result sellerLogin(@RequestBody TbSeller bean ,HttpServletRequest  request, HttpServletResponse response ) throws UnsupportedEncodingException{
		...
		if (seller!=null) {
			...
			//	request.getSession().setAttribute("seller", URLEncoder.encode(seller.getSellerId(),"utf-8"));
				Cookie cookie = new Cookie(Enumeration.CURRENT_SELLER, URLEncoder.encode(seller.getSellerId(),"utf-8"));  
				cookie.setMaxAge(3600 * 1);
				cookie.setPath("/");
				response.addCookie(cookie);
				Cookie cookie2 = new Cookie(Enumeration.CURRENT_SELLER_NAME, URLEncoder.encode(seller.getName(),"utf-8"));  
	 ...
	 */
	@RequestMapping("/exit")
	public Result Exit(String sellerId,String name,HttpServletRequest  request, HttpServletResponse response ) throws UnsupportedEncodingException{

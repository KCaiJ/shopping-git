...
public class ContentCategoryController {
	...
	public PageResult findPage(int page, int rows) {
		return Service.queryPageListByWhere(new TbContentCategory(), page, rows);
	}
	...
	@RequestMapping("/add")
	public Result add(@RequestBody TbContentCategory bean) {
		try {
			Service.save(bean);
	...
	public Result update(@RequestBody TbContentCategory bean) {
		try {
			Service.update(bean);
	...
	public PageResult search(int page, int rows, @RequestBody TbContentCategory bean) {
